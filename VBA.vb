...
sub degreechooser
 Dim s As String
 s = InputBox("Scegli il corso di laurea "	 & Chr(13) & _
         Chr(13) & "1 - Ingegneria Informatica" & _
         Chr(13) & "2 - Ingegneria Gestionale" & _
         Chr(13) & "3 - Ingegneria Edile" & _
         Chr(13) & "4 - Ingegneria Di internet" & _
         Chr(13) & "5 - Ingegneria dell'edilizia" & _
         Chr(13) & "6 - Ingegneria Elettronica"	 & _
         Chr(13) & "7 - Ingegneria di semone", "Option Chooser")
 Select Case s
     Case "1"
